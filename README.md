...
Quickly publish your Minecraft mods to multiple mod hosting sites using IntelliJ IDEA and Visual Studio Code.

It may not be as convenient as some Gradle plugins, but I want to do it.

**If you're looking for ModPublish for Visual Studio Code, see** [here](modpublish-vscode/README.md).

**If you're looking for ModPublish for IntelliJ IDEA, see** [here](modpublish-intellij/README.md).
