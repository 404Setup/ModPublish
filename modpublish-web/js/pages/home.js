...
window.ModPublish.pages.home = {
                ...
                <section class="hero animate-fade-in">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-actions">
                            ...
                            <a href="https://github.com/404Setup/ModPublish" target="_blank" rel="noopener" class="btn btn-secondary" id="github-star-btn">
    ...
    fetchGithubStars: function () {
        ...
        const cachedStars = window.ModPublish.getCookie('modpublish_github_stars');
        if (cachedStars) {
            this.updateStarButton(starBtn, cachedStars);
            return;
        }

        this.abortController = new AbortController();

        window.ModPublish.fetchWithFallback('https://api.github.com/repos/404Setup/ModPublish', {
            ...
            .then(data => {
                if (data && typeof data.stargazers_count === 'number') {
                    ...
                    window.ModPublish.setCookie('modpublish_github_stars', stars, 7);
                    this.updateStarButton(starBtn, stars);
                }
            })
            .catch(err => {
                if (err.name === 'AbortError') {
                    console.log('GitHub stars fetch aborted');
                } else {
    ...
    updateStarButton: function (btn, stars) {
        const btnText = btn.querySelector('.btn-text');
        if (btnText) {
            btnText.innerHTML = `Star on GitHub <span class="star-badge">★ ${stars}</span>`;
        }
    }
};
